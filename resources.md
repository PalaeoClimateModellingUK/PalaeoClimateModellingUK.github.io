...
[Idiot's Guide, Part 1 - Setting up and running PI.pdf](https://github.com/user-attachments/files/29003227/Idiot.s.Guide.Part.1.-.Setting.up.and.running.PI.pdf) (last updated 1430 BST on 16/6/26)
...
[Idiot's Guide, Part 2 - Setting up new LSM.pdf](https://github.com/user-attachments/files/29055640/Idiot.s.Guide.Part.2.-.Setting.up.new.LSM.pdf) (last updated 1630 BST on 17/6/26)
...
[Idiot's Guide, Part 3 - Changing ancillaries and other science modifications.pdf](https://github.com/user-attachments/files/29003243/Idiot.s.Guide.Part.3.-.Changing.ancillaries.and.other.science.modifications.pdf) (last updated 1430 BST on 16/6/26)

* Part 4: This gives instructions on how to actually run the suite when everything is ready, monitor it, check output, and fix potential problems. (last updated 1430 BST on 16/6/26)
